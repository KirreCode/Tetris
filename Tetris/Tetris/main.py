...
lines_rect = pygame.Rect(320, 450, 170, 60)
level_rect = pygame.Rect(320, 550, 170, 60)
...
while True:
    ...
    screen.blit(lines_surface, (375, 410, 50, 50))
    screen.blit(level_surface, (375, 520, 50, 50))
    ...
    screen.blit(lines_value_surface, lines_value_surface.get_rect(centerx = lines_rect.centerx,
